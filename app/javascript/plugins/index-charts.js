...
var lineChartConfig = {
	...
	options: {
		...
		title: {
			display: true,
			text: 'Chart.js Пример линейного графика',
		}, 
		tooltips: {
			mode: 'index',
			intersect: false,
...
var barChartConfig = {
	...
	options: {
		...
		title: {
			display: true,
			text: 'Chart.js Пример гистограммы'
		},
		tooltips: {
			mode: 'index',
			intersect: false,
...
window.addEventListener('turbolinks:load', function(){
	...
	if(barChart) {
		window.myBar = new Chart(barChart.getContext('2d'), barChartConfig)
	}
})