...
set :application_name, 'itportal'
set :domain, '10.10.2.32'
set :user, fetch(:application_name)
set :deploy_to, "/var/www/#{fetch(:user)}.adm.tver.ru/app"
set :repository, 'git@github.com:andresys/itportal.git'
set :branch, 'main'
...
set :shared_files, fetch(:shared_files, []).push('config/database.yml', 'config/secrets.yml', 'config/http1c.yml', 'config/phonebook.yml')
